...
class ObjectDetector(classifier_extended.ClassifierExtended):
    ...
    """
        ...
        object_detector._create_and_train_model(train_data, validation_data, callbacks)  # ADD
    ...
    """
        ...
        self._create_model()
        self._train_model(
            train_data, validation_data, callbacks, preprocessor=self._preprocessor,  # ADD
        )
